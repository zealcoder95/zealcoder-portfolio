  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-slate-950 px-6 pt-36 text-white">
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-9rem)] max-w-7xl items-center gap-20 lg:grid-cols-2">
        {/* LEFT */}
        <div>
          <div className="mb-8 inline-flex items-center gap-3 rounded-full border border-cyan-400/20 bg-cyan-400/5 px-5 py-2 backdrop-blur">
          ...
          <h1 className="mb-8 text-5xl font-black leading-[1.05] md:text-7xl">
            Building{" "}
            <span className="zeal-text-gradient">
              intelligence
            </span>
          ...
          <div className="mb-14 flex flex-wrap gap-4">
            <Link
              href="/projects"
              className="zeal-button-gradient rounded-full px-8 py-4 font-bold text-white shadow-xl shadow-cyan-500/20 transition duration-300 hover:-translate-y-1 hover:shadow-cyan-500/40"
            >
            ...
            <Link
              href="/learning"
              className="rounded-full border border-cyan-300/30 bg-white/5 px-8 py-4 font-bold text-cyan-300 backdrop-blur transition duration-300 hover:-translate-y-1 hover:bg-cyan-400/10"
            >
          ...
          <div className="grid max-w-xl grid-cols-3 gap-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur">
              <h3 className="text-3xl font-black text-purple-300">100%</h3>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur">
              <h3 className="text-3xl font-black text-cyan-300">∞</h3>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="relative rounded-full border border-cyan-300/20 bg-white/5 p-6 shadow-[0_0_80px_rgba(34,211,238,0.18)] backdrop-blur-xl">
            <img
              src="/assets/zealcoder-logo.png"
              alt="ZealCoder Logo"
              className="h-80 w-80 rounded-full object-cover transition duration-500 hover:scale-105 md:h-96 md:w-96"
            />
          </div>

          <div className="absolute left-0 top-16 hidden rounded-2xl border border-white/10 bg-slate-900/70 px-5 py-4 backdrop-blur lg:block">
          ...
          <div className="absolute bottom-16 right-0 hidden rounded-2xl border border-white/10 bg-slate-900/70 px-5 py-4 backdrop-blur lg:block">
