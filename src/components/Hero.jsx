      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-9rem)] max-w-7xl items-center gap-16 lg:grid-cols-2">
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="/projects"
              className="zeal-button-gradient rounded-full px-7 py-4 font-bold text-white shadow-lg shadow-cyan-500/20 transition hover:-translate-y-1"
            >
        ...
        <div className="relative flex flex-col items-center">
          <div className="zeal-glow-gradient absolute h-[520px] w-[520px] animate-pulse rounded-full blur-3xl" />
