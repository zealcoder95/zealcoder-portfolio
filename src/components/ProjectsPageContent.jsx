...
export default function ProjectsPageContent({ projects }) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-16">
      <p className="mb-4 text-sm font-semibold uppercase tracking-[0.45em] text-cyan-300/90">
        {lang === "en" ? "Selected work" : "Seçilmiş çalışmalar"}
      </p>

      <h1 className="mb-6 max-w-4xl text-4xl font-black leading-tight text-white sm:text-5xl md:text-6xl">
        {lang === "en"
      ...
      <div className="space-y-10">
        ...
        {archiveProjects.length > 0 && (
          <section className="rounded-[32px] border border-white/10 bg-slate-950/80 p-8 shadow-lg shadow-slate-950/20">
            <div className="mb-10">
