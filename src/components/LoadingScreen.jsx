  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-950 text-white">
      <div className="text-center">
        ...
        <h1 className="mb-4 bg-gradient-to-r from-purple-400 to-cyan-300 bg-clip-text text-4xl font-black tracking-[0.25em] text-transparent">
          ZEALCODER
        </h1>
        ...
        <div className="mx-auto mt-6 h-2 w-64 overflow-hidden rounded-full bg-slate-800">
          <div className="h-full w-full animate-[loading_1.8s_ease-in-out] rounded-full bg-gradient-to-r from-purple-500 to-cyan-400" />
        </div>
      </div>
    </div>
  );
